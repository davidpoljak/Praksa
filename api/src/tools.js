...
function pripremiFoldere() {
    fs.exists(appConfig.directoryParams.uploadPath, function (exists) {
        if (exists) { } else {
            fs.mkdir(appConfig.directoryParams.uploadPath, function (err) {
                if (err) {
                    systemLogger.log({
                        level: 'error',
    ...
    fs.exists(appConfig.directoryParams.uploadPathTest, function (exists) {
        if (exists) { } else {
            fs.mkdir(appConfig.directoryParams.uploadPathTest, function (err) {
                if (err) {
    ...
    fs.exists(appConfig.directoryParams.nodeSrv + 'logs', function (exists) {
        if (exists) { } else {
            fs.mkdir(appConfig.directoryParams.nodeSrv + 'logs', function (err) {
                if (err) {
